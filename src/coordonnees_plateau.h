 ...
 * ********************************************
 *  change la valeur des coordonnées (x,y) en fonction de l'orientation passée en paramétre
 *  En partique, cette fonction fait bouger la pièce suivant une orientation intégre
 *  Necessite:
 *  deux pointeurs de coordonnées non nuls
 *  une orientation intégre
 *  Garantie:
 *  Modifie la valeur de x ou de y en fonction de l'orientation
 */
