 ...
 *********************************
 *    Definie une piece comme un rocher n'ayant pas d'orientation
 *
 *    Necessite:
 *      - Un pointeur non NULL vers une piece_siam modifiable.
 *      
 *    Garantie:
 *      - Une piece mise a jour.
 *      - La piece doit etre integre.
 */
 ...
 ************************************
 *    Definie une piece comme une case vide n'ayant pas d'orientation
 *
 *    Necessite:
 *      - Un pointeur non NULL vers une piece_siam modifiable.
 *      
 ...
 * ****************************
 *  Fonction qui fait correspondre une piece au nom qui est indiqué en parametre.
 *   
 *  Necessite:
 *    - Un pointeur non NULL vers une chaine de caractère indiquant le nom de la pièce
 *  Garantie:
 *    - renvoie une piece_siam: différentes possibilités:
 *
 *          - nom vaut "***" -> case vide
 *          - nom vaut "RRR" -> rocher
