 ...
 *    C'est a dire que la valeur du type doit etre soit haut, gauche, droite, bas ou aucune_orientation.
 *    
 *
 *    Necessite:
 *      - Une enumeration de type orientation_deplacement
 *    Garantie:
 *      - Un retour valant 1 si le orientation_deplacement correspond aux orientations prevus.
